...
export async function postApiV1ThingsProductInfoCreate(
  ...
  return request<{ code: number; msg: string }>('/v1/things/product/info/create', {
    method: 'POST',
    headers: {
...
export async function postApiV1ThingsProductInfo__openAPI__delete(
  ...
  return request<{ code: number; msg: string }>('/v1/things/product/info/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function postApiV1ThingsProductInfoUpdate(
  ...
  return request<{ code: number; msg: string }>('/v1/things/product/info/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
