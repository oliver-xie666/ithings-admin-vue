...
/** 获取验证码 POST /v1/system/user/captcha */
...
/** 创建用户信息 POST /v1/system/user/create */
export async function postApiV1SystemUserCreate(
  ...
  return request<{ code: number; msg: string; uid: number }>('/v1/system/user/create', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 删除用户 POST /v1/system/user/delete */
export async function postApiV1SystemUser__openAPI__delete(
  ...
  return request<{ code: number; msg: string }>('/v1/system/user/delete', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 获取用户信息列表 POST /v1/system/user/index */
...
/** 获取用户信息 POST /v1/system/user/read */
...
/** 获取用户资源 POST /v1/system/user/resource-read */
...
/** 更新用户基本数据 POST /v1/system/user/update */
